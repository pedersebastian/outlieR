...
test_that("equals", {
  ...
  expect_identical(subset(mtcars, c(FALSE, FALSE, rep(TRUE, 30))), filtred_V2)
  expect_identical(subset(mtcars, c(rep(TRUE, 29), FALSE, FALSE, TRUE)), filtred_V1)
  expect_identical(subset(mtcars, c(rep(TRUE, 29), FALSE, FALSE, FALSE)), filtred_V1_omit)
})
