...
#
#
# num_methods <- c("mean_sd", "MAD", "IQD", "t_test", "fake")
...
# set.seed(123)
# res <-
#   tidyr::expand_grid(col_names, num_methods, threshold, conf_int, na_action) |>
#   dplyr::slice_sample(n = 2000) |>
#   tibble::rownames_to_column() |>
#   tidyr::nest(data = -rowname) |>
#   dplyr::mutate(test = purrr::map(data, ~ pol_outlier(
#     .data = mtcars,
#     .x$col_names,
#     num_method = .x$num_methods,
